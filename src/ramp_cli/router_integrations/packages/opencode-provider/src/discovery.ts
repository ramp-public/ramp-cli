...
export type RouterModelMetadata = {
  ...
  /** Whether asking for a summary shape does anything, or is discarded. */
  reasoningSummaryRequestable: boolean
...
export function parseRouterMetadata(
  ...
  const summaryRequestable = flag(summary.request_parameter_supported) ?? false
  ...
  return {
    ...
    reasoningSummaryRequestable: summaryRequestable,
